...
export const OnboardingScreen3 = ({ path }: { path: string }) => {
  const title = 'Un nuevo mundo de compras';
  const description =
    'Únete al futuro, y descubre la comonidad y flexibilidad de comprar con Finity.';

  return (
    <View>
      <View className={styles.imageContainer}>
        <Image 
          source={require('../../../assets/onboarding/onboarding-3/onboarding-3.png')}
